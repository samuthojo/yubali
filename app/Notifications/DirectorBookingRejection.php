...
class DirectorBookingRejection extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
      ...
      return (new MailMessage)
                ->subject('Yubali - A member rejected a booking!')
                ->greeting('Hello!')
                ->line($member_name . ' rejected a booking.')
                ->line('Reason: ' . $this->booking->reason)
                ->line('See the details of the booking request below: ')
